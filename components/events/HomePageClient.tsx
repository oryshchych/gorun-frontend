    ...
    <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
      <Card className="mb-8 p-3 sm:p-4">
        <TabsList className="flex w-full bg-transparent p-0 gap-2 sm:gap-1 sm:grid sm:grid-cols-3">
          <TabsTrigger
            value="description"
            className="flex-1 sm:flex-none min-h-[44px] px-3 py-2.5 sm:py-1.5 text-xs sm:text-sm whitespace-nowrap bg-transparent text-ink-3 data-[state=active]:bg-brand data-[state=active]:text-on-brand data-[state=active]:shadow-sm transition-all rounded-md"
          >
            {t("event.description")}
          </TabsTrigger>
          <TabsTrigger
